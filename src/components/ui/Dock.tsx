  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center">
      <motion.div
        ...
        className={`${className} absolute ${position === 'center' ? 'top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2' : 'bottom-2 left-1/2 -translate-x-1/2'} transform flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
